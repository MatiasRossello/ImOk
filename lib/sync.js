...
// Fixed global topic. Constant in v1, not configurable: every peer meets in the
// same place or the network partitions for no good reason.
const TOPIC = crypto.hash(b4a.from('imok:v1:global'))
